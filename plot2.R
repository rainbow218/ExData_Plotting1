...
subset_data <- subset(data,   select = c("Date","Time","Global_active_power"))
...
par(mfrow=c(1,1))
plot(subset_data_2$Time,subset_data_2$Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab="")
