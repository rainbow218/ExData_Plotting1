...
subset_data <- subset(data,   select = c("Date","Time","Sub_metering_1","Sub_metering_2","Sub_metering_3","Global_active_power","Voltage","Global_reactive_power"))
...
par(mfrow = c(2,2))
plot(subset_data_2$Time,subset_data_2$Global_active_power,ylab="Global Active Power",xlab="", type="l", pin=c(2.2,2.2))
plot(subset_data_2$Time,subset_data_2$Voltage, ylab  = "Voltage", type = "l",xlab="datetime")
...
plot(subset_data_2$Time,subset_data_2$Global_reactive_power,ylab="Global_reactive_power", type="l",xlab="datetime")
